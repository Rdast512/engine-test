...
// TODO Rewrite to RAII
// TODO add support for GLTF and PBR
// TODO Push constants
// TODO Instanced rendering
// TODO Dynamic uniforms
// TODO Separate images and sampler descriptors
// TODO Pipeline cache
...
static std::vector<char> readFile(const std::string& filename) {
    ...
    boost::filesystem::ifstream file(filePath, std::ios::ate | std::ios::binary);
...
private:
    ...
    void createInstance() {
        ...
        .set_debug_callback([](VkDebugUtilsMessageSeverityFlagBitsEXT severity,
                      ...
                      void* pUserData) -> VkBool32 {
                        ...
                        // Filter out ReShade-related messages
                        if (std::string(pCallbackData->pMessage).find("ReShade") != std::string::npos) {
                            return VK_FALSE;
                        }

                        // Filter out Social Club layer messages
                        if (std::string(pCallbackData->pMessage).find("SocialClubVulkan") != std::string::npos) {
                            return VK_FALSE;
                        }
    ...
    void createPhysicalDevice() {
        ...
        msaaSamples = std::min(msaaSamples, VK_SAMPLE_COUNT_4_BIT);
        cout << "msaaSamples: " << msaaSamples << endl;
    ...
    void createRenderPass() {
        ...
        colorAttachment.finalLayout = VK_IMAGE_LAYOUT_PRESENT_SRC_KHR;  // Add this line
    ...
    void createGraphicsPipeline() {
        ...
        multisampling.minSampleShading = .5f;
    ...
    void createTextureImage() {
        ...
        createImage(texWidth, texHeight, mipLevels, VK_SAMPLE_COUNT_1_BIT, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, textureImage, textureImageMemory);transitionImageLayout(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, mipLevels);
    ...
    void createTextureSampler() {
        ...
        cout<< "Max Anisotropy: " << properties.limits.maxSamplerAnisotropy << endl;
    ...
    void loadModel() {
        ...
        cout << "Loaded " << vertices.size() << " vertices and " << indices.size() << " indices from model." << endl;
    }
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.model = glm::rotate(glm::mat4(1.0f), glm::radians(15.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ubo.view = glm::lookAt(glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        // Camera positioned above looking down
        // ubo.view = glm::lookAt(
        //     glm::vec3(0.0f, 0.0f, 5.0f),   // Camera position (above)
        //     glm::vec3(0.0f, 0.0f, 0.0f),   // Look at center
        //     glm::vec3(0.0f, -1.0f, 0.0f)   // Up vector (negative Y-axis to correct mirroring)
        // );
